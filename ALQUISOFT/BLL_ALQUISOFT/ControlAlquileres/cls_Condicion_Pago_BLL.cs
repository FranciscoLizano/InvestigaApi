    ...
    public class cls_Condicion_Pago_BLL
    {
        public void listarCondicionPago(ref cls_Condicion_Pago_DAL obj_Condicion_Pago_DAL)
        {
            try
            {
                ...
                obj_Condicion_Pago_DAL.dtParametros = null;

                /*Definir el nombre del KEY que contiene el nombre del procedimiento almacenado de la base de datos*/
                obj_BD_DAL.sNomSP = ConfigurationManager.AppSettings["SP_LST_Condicion_Pago"];
                ...
                obj_BD_DAL.DT_Parametros = obj_Condicion_Pago_DAL.dtParametros;
                /*Definimos un nombre lógico a la tabla de respuesta*/
                obj_BD_DAL.sNomTabla = "Condicion_Pago";
                ...
                {
                    obj_Condicion_Pago_DAL.dtDatos = obj_BD_DAL.DS.Tables[0];
                }
                else
                {
                    obj_Condicion_Pago_DAL.dtDatos = null;
                }
            }
            catch (Exception ex)
            {
