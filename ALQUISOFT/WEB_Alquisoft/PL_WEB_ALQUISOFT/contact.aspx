            ...
            <div class="container py-lg-5">
                <div class="top-map">
                    <div class="map-content-9">
                        <form action="javascript: EnvioCorreos()" method="post">
                            <div class="form-top1">
                                ...
                                <div class="form-top">
                                    <div class="form-top-left">
                                        ...
                                        <input type="number" name="w3lPhone" id="w3lPhone" placeholder="Número de teléfono*" required="">
                                        <input type="email" name="w3lSender" id="w3lSender" placeholder="Correo electrónico*" required="">
                                        <input type="text" name="w3lSubject" id="w3lAsunto" placeholder="Asunto" required="">
                                    </div>
