...
{
    public class cls_Condicion_Pago_DAL
    {
        #region Variables Privadas
        /*Sección de campos de la tabla*/
        private int _iId_CondPago;
        private string _sCondPago;
        /*Sección de campos de la tabla*/
        ...
        public int iId_CondPago { get => _iId_CondPago; set => _iId_CondPago = value; }
        public string sCondPago { get => _sCondPago; set => _sCondPago = value; }
